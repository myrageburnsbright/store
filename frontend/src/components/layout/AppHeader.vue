        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="authStore.isAuthenticated" class="relative">
            <button
              ...
              class="flex items-center space-x-2 p-2 rounded-md hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-accent-500"
            >
              <div class="w-8 h-8 bg-accent-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
