        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <p class="text-sm text-gray-600 mb-4 max-w-md">
              Your trusted online marketplace for quality products at great prices. Shop with confidence and enjoy fast, reliable shipping.
            </p>
          ...
          <div>
            ...
            <ul class="space-y-3 text-sm">
              <li>
                <router-link
                  :to="{ name: 'products' }"
                  class="text-gray-600 hover:text-accent-600 transition-colors"
                >
                  All Products
                </router-link>
              </li>
      ...
      <div class="border-t border-gray-200 py-6">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex items-center space-x-6 mt-4 md:mt-0 text-sm">
            ...
            <button
              @click="scrollToTop"
              class="flex items-center space-x-1 text-gray-500 hover:text-accent-600 transition-colors"
            >
...
import { ShoppingBagIcon, ArrowUpIcon } from '@heroicons/vue/24/outline'
